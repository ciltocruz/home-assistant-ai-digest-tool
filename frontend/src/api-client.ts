import {
  ...
  IgnoreRuleDtoSchema,
  ExactProblemIgnoreResultSchema,
  ManualTelegramSendRequestSchema,
  ManualTelegramSendResultSchema,
  NoteCreateSchema,
  NoteDtoSchema,
  ...
  type IgnoreRuleDto,
  type ExactProblemIgnoreResult,
  type ManualTelegramSendResult,
  type NoteCreate,
  type NoteDto,
...
export function createApiClient(options: ApiClientOptions = {}) {
  ...
  return {
    ...
    ignoreReportProblem: (reportId: string, signature: string): Promise<ExactProblemIgnoreResult> => request(`/api/digests/${encodeURIComponent(reportId)}/problems/${encodeURIComponent(signature)}/ignore`, ExactProblemIgnoreResultSchema, { method: 'POST', body: JSON.stringify({}) }),
    sendReportViaTelegram: (reportId: string, actionId: string): Promise<ManualTelegramSendResult> => request(`/api/digests/${encodeURIComponent(reportId)}/manual-telegram-sends`, ManualTelegramSendResultSchema, { method: 'POST', body: JSON.stringify(ManualTelegramSendRequestSchema.parse({ actionId, confirmed: true })) }),
